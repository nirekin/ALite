...
/**
 * Implementation of a "less than or equal" restriction on two attributes
 *
 * @author Guillaume Barré
 * @since 1.0
 *
 */
public class LowerEqualsPropExp implements Criterion{
	 ...
	 */
	protected LowerEqualsPropExp(String attr1, String attr2){
		pN = attr1;
		oN = attr2;
	}
