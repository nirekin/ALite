...
/**
 * Implementation of a "less than" restriction on the specified attribute
 *
 * @author Guillaume Barré
 * @since 1.0
 *
 */
public class LowerThanExp implements Criterion{
	 ...
	 */
	protected LowerThanExp(String attr, Object value){
		pN = attr;
		v = value;
	}
