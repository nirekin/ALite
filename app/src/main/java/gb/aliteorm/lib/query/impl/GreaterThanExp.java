...
/**
 * Implementation of a "greater than" restriction on the specified attribute
 *
 *
 ...
 *
 */
public class GreaterThanExp implements Criterion{
	 ...
	 */
	protected GreaterThanExp(String attr, Object value){
		pN = attr;
		v = value;
	}
