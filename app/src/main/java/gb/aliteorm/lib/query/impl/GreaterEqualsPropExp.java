...
/**
 * Implementation of a "greater than or equal" restriction on two attributes
 *
 *
 ...
 *
 */
public class GreaterEqualsPropExp implements Criterion{
	 ...
	 */
	protected GreaterEqualsPropExp(String attr1, String attr2){
		pN = attr1;
		oN = attr2;
	}
