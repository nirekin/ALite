...
/**
 * Implementation of a "greater than or equal" restriction on the specified attribute.
 *
 *
 ...
 *
 */
public class GreaterEqualsExp implements Criterion{
	 ...
	 */
	protected GreaterEqualsExp(String attr, Object value){
		pN = attr;
		v = value;
	}
