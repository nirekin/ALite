...
/**
 * Implementation of a "less than or equal" restriction on the specified attribute
 *
 * @author Guillaume Barré
 * @since 1.0
 *
 */
public class LowerEqualsExp implements Criterion{
	 ...
	 */
	protected LowerEqualsExp(String attr, Object value){
		pN = attr;
		v = value;
	}
