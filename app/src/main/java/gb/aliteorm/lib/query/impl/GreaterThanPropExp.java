...
/**
 * Implementation of a "greater than" restriction to two attributes
 *
 *
 ...
 *
 */
public class GreaterThanPropExp implements Criterion{
	 ...
	 */
	protected GreaterThanPropExp(String attr1, String attr2){
		pN = attr1;
		oN = attr2;
	}
