...
/**
 * Specifies the length of the String attribute corresponding to the annotated getter method.
 * <p>
...
public @interface ALiteStringLength {
	/**
	 * Returns the desired String length
