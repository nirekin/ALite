...
/**
 * Database column to map <code>long</code> and <code>Long</code> values.
 *
 * @author Guillaume Barré
 * @since 1.0
 *
 */
public class DBColumnLong extends DBColumnImpl{

	/**
	 * New column to map <code>long</code> and <code>Long</code> values
	 * 
	 ...
	 */
	protected DBColumnLong(String tableName,Attribute a, Method getter) throws UnsupportedGetterException{
	...
	public void readAttributed(StringBuilder strb, Object target){
		try {
			strb.append((long)a.getGetter().invoke(target));
		}catch(Exception e) {
			Log.e("bccore", "Error getter long :" + a.getModelName() );
		}
	}
